...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/hunter24x24/approvel_key/blob/main/key.txt"])
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/hunter24x24/approvel_key/blob/main/key.txt').text
			if basesplit in plr:
				key = basesplit
